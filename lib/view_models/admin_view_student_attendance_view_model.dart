...
final adminViewStudentAttendanceViewModel =
StateNotifierProvider<AdminViewStudentAttendanceViewModel, Map<String, dynamic>>(
        (ref) => AdminViewStudentAttendanceViewModel(ref));

class AdminViewStudentAttendanceViewModel extends BaseViewModel<Map<String, dynamic>> {

  AdminViewStudentAttendanceViewModel(this.ref,) : super({});
  ProviderReference ref;

  final AdminViewStudentAttendanceRepository _repository = AdminViewStudentAttendanceRepository();
