...
import 'package:uqu_map_app/view_models/student_view_schedule_information_view_model.dart';
...
class StudentViewScheduleInformationView extends StatelessWidget {
  const StudentViewScheduleInformationView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AppStyles.customScaffold(
        "Schedules", StudentViewScheduleViewBody());
  }
}

class StudentViewScheduleViewBody extends StatefulWidget {
  const StudentViewScheduleViewBody({Key? key}) : super(key: key);

  @override
  _StudentViewScheduleViewBodyState createState() => _StudentViewScheduleViewBodyState();
}

class _StudentViewScheduleViewBodyState extends State<StudentViewScheduleViewBody> {

  late StudentViewScheduleViewModel viewModel;

  @override
  void initState() {
    super.initState();
    viewModel = context.read(studentViewScheduleViewModel.notifier);
