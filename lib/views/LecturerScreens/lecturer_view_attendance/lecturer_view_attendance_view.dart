...
class LecturerViewAttendanceView extends StatelessWidget {
  const LecturerViewAttendanceView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AppStyles.customScaffold("Attendance",LecturerViewAttendanceViewBody());
  }
}


class LecturerViewAttendanceViewBody extends StatefulWidget {
  const LecturerViewAttendanceViewBody({Key? key}) : super(key: key);

  @override
  _LecturerViewAttendanceViewBodyState createState() => _LecturerViewAttendanceViewBodyState();
}

class _LecturerViewAttendanceViewBodyState extends State<LecturerViewAttendanceViewBody> {

  late LecturerViewAttendanceViewModel viewModel;

  @override
  void initState() {
    super.initState();
    viewModel = context.read(lecturerViewAttendanceViewModel.notifier);
