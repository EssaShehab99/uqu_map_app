...
import 'package:uqu_map_app/view_models/admin_view_lecturer_attendance_view_model.dart';
...
class AdminViewLecturerAttendance extends StatelessWidget {
  const AdminViewLecturerAttendance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AppStyles.customScaffold("Lecturer Attendance",AdminViewLecturerAttendanceBody());
  }
}

class AdminViewLecturerAttendanceBody extends StatefulWidget {
  const AdminViewLecturerAttendanceBody({Key? key}) : super(key: key);

  @override
  _AdminViewLecturerAttendanceBodyState createState() => _AdminViewLecturerAttendanceBodyState();
}

class _AdminViewLecturerAttendanceBodyState extends State<AdminViewLecturerAttendanceBody> {

  late AdminViewLecturerAttendanceViewModel viewModel;

  @override
  void initState() {
    super.initState();
    viewModel = context.read(adminViewLecturerAttendanceViewModel.notifier);
  ...
  Widget viewAttendanceButton(AdminViewLecturerAttendanceViewModel viewModel, User user) {
    return Column(
      children: [
        Row(
          children: [
